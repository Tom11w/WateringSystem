...
```
cd existing_repo
git remote add origin http://fast.local/waterdiviners/wateringsystem.git
git branch -M main
...
- [ ] [Set up project integrations](http://fast.local/waterdiviners/wateringsystem/-/settings/integrations)
